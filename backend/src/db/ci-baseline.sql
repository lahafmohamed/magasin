...
--
-- Name: transfer_statut_new; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: adjust_stock_at_location(integer, integer, integer, character varying); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: assert_ecriture_period_open(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.assert_ecriture_period_open() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
  v_statut TEXT;
...
--
-- Name: calculer_solde_client(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: calculer_solde_fournisseur(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: calculer_solde_net(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: convert_bl_to_facture(integer, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: convert_devis_to_bl(integer, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: convert_devis_to_facture(integer, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: create_avoir_from_retour(integer, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: create_ecritures_facture_client(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: create_ecritures_facture_fournisseur(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: enforce_acompte_application_cap(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: enforce_acompte_fournisseur_application_cap(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: enforce_mouvement_append_only(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: enforce_mouvement_magasin_coherence(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: enforce_paiement_espece_mouvement(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION enforce_paiement_espece_mouvement(); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: enforce_stock_valeur_invariant(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.enforce_stock_valeur_invariant() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: ensure_plan_compte(character varying, character varying, character varying, character varying); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: generate_demande_numero(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION generate_demande_numero(); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: generate_tiers_code(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: get_stock_at_location(integer, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: get_user_default_location_id(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: get_user_location_role(integer, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: log_demande_state_change(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: sync_acompte_after_application(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: sync_acompte_fournisseur_state(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: sync_cmp_to_produit(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.sync_cmp_to_produit() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  UPDATE produits
...
--
-- Name: sync_demande_on_transfer_change(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: transferer_fonds_caisse(integer, integer, numeric, integer, text); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: update_crm_timestamp(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_crm_timestamp() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  NEW.updated_at = NOW();
...
--
-- Name: update_facture_fournisseur_payment_status(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: update_facture_ht_ttc(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: update_facture_on_payment_delete(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: update_facture_payment_status(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: update_produits_stock_from_locations(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_internal_stock_request_lignes; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_internal_stock_requests; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public._deprecated_internal_stock_requests (
    ...
    CONSTRAINT internal_stock_requests_statut_check CHECK (((statut)::text = ANY (ARRAY[('en_attente'::character varying)::text, ('validee'::character varying)::text, ('refusee'::character varying)::text, ('executee'::character varying)::text, ('annulee'::character varying)::text])))
);


--
-- Name: TABLE _deprecated_internal_stock_requests; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN _deprecated_internal_stock_requests.statut; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_three_way_match_details_2026_05; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE _deprecated_three_way_match_details_2026_05; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_three_way_matches_2026_05; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public._deprecated_three_way_matches_2026_05 (
    ...
    valide_par integer,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT three_way_matches_statut_check CHECK (((statut)::text = ANY (ARRAY[('en_attente'::character varying)::text, ('valide'::character varying)::text, ('ecart_identifie'::character varying)::text, ('rejete'::character varying)::text])))
);


--
-- Name: TABLE _deprecated_three_way_matches_2026_05; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications_fournisseur; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications_fournisseur_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications_fournisseur_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: acomptes_clients; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.acomptes_clients (
    ...
    statut character varying(30) DEFAULT 'disponible'::character varying,
...
--
-- Name: TABLE acomptes_clients; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN acomptes_clients.magasin_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: acomptes_clients_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: acomptes_clients_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: acomptes_fournisseur; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE acomptes_fournisseur; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN acomptes_fournisseur.session_caisse_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN acomptes_fournisseur.mouvement_caisse_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: acomptes_fournisseur_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: acomptes_fournisseur_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: allocation_audit_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: allocation_audit_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: avoir_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: TABLE barcode_scans; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: bl_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: bon_livraison_lignes; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: bon_livraison_lignes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: bon_livraison_lignes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: bons_livraison; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.bons_livraison (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT bons_livraison_statut_check CHECK (((statut)::text = ANY (ARRAY[('brouillon'::character varying)::text, ('valide'::character varying)::text, ('livre'::character varying)::text, ('facture'::character varying)::text, ('annule'::character varying)::text])))
);


--
-- Name: bons_livraison_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: bons_livraison_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.caisses (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT caisses_type_check CHECK (((type)::text = ANY (ARRAY[('principale'::character varying)::text, ('magasin'::character varying)::text])))
);


--
-- Name: TABLE caisses; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: camion_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: commande_numero_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: commandes_fournisseur; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.commandes_fournisseur (
    ...
    deleted_at timestamp without time zone,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT commandes_fournisseur_statut_check CHECK (((statut)::text = ANY (ARRAY[('en_attente'::character varying)::text, ('validee'::character varying)::text, ('expediee'::character varying)::text, ('livree'::character varying)::text, ('annulee'::character varying)::text])))
);


--
-- Name: commandes_fournisseur_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: commandes_fournisseur_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: commissions_ventes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commissions_ventes (
    id integer NOT NULL,
    ...
    statut character varying(20) DEFAULT 'en_attente'::character varying,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT commissions_ventes_statut_check CHECK (((statut)::text = ANY ((ARRAY['en_attente'::character varying, 'validee'::character varying, 'payee'::character varying])::text[])))
);


--
-- Name: commissions_ventes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commissions_ventes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: commissions_ventes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commissions_ventes_id_seq OWNED BY public.commissions_ventes.id;
...
CREATE TABLE public.company_settings (
    ...
    nom character varying(100) DEFAULT 'Hitek-CI'::character varying NOT NULL,
    adresse text DEFAULT 'Abidjan, Côte d''Ivoire'::text,
    telephone character varying(50) DEFAULT '+225 07 00 00 00'::character varying,
    email character varying(100) DEFAULT 'contact@hitek-ci.com'::character varying,
    site_web character varying(100) DEFAULT 'www.hitek-ci.com'::character varying,
    nif character varying(50) DEFAULT ''::character varying,
    rc character varying(50) DEFAULT ''::character varying,
    ai character varying(50) DEFAULT ''::character varying,
    cb character varying(100) DEFAULT ''::character varying,
    devise character varying(10) DEFAULT 'FCFA'::character varying,
...
CREATE TABLE public.compensations (
    ...
    CONSTRAINT compensations_statut_check CHECK (((statut)::text = ANY (ARRAY[('valide'::character varying)::text, ('annule'::character varying)::text])))
);


--
-- Name: TABLE compensations; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: compte_client_lignes; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.compte_client_lignes (
    ...
    cree_par integer,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT compte_client_lignes_type_operation_check CHECK (((type_operation)::text = ANY (ARRAY[('facture'::character varying)::text, ('paiement'::character varying)::text, ('acompte'::character varying)::text, ('avoir'::character varying)::text, ('remise'::character varying)::text, ('ajustement'::character varying)::text, ('compensation'::character varying)::text])))
);


--
-- Name: TABLE compte_client_lignes; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: compte_client_lignes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: compte_client_lignes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: compte_fournisseur_lignes; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.compte_fournisseur_lignes (
    ...
    cree_par integer,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT compte_fournisseur_lignes_type_operation_check CHECK (((type_operation)::text = ANY (ARRAY[('facture'::character varying)::text, ('paiement'::character varying)::text, ('avoir'::character varying)::text, ('ajustement'::character varying)::text, ('compensation'::character varying)::text, ('acompte'::character varying)::text])))
);


--
-- Name: TABLE compte_fournisseur_lignes; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: compte_fournisseur_lignes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: compte_fournisseur_lignes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.crm_interactions (
    id integer NOT NULL,
    tiers_id integer NOT NULL,
    type character varying(50) DEFAULT 'appel'::character varying NOT NULL,
    sujet character varying(200) NOT NULL,
    description text,
    date_interaction timestamp with time zone DEFAULT now() NOT NULL,
    date_rappel timestamp with time zone,
    rappel_fait boolean DEFAULT false,
    statut character varying(20) DEFAULT 'termine'::character varying NOT NULL,
...
--
-- Name: crm_taches; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.crm_taches (
    id integer NOT NULL,
    tiers_id integer,
    titre character varying(200) NOT NULL,
    description text,
    priorite character varying(20) DEFAULT 'normale'::character varying,
    statut character varying(20) DEFAULT 'a_faire'::character varying,
    date_echeance date,
    assigne_a integer,
    cree_par integer,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
...
--
-- Name: crm_taches_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.crm_taches_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: crm_taches_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.crm_taches_id_seq OWNED BY public.crm_taches.id;


--
-- Name: demande_reappro_numero_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.demandes_reapprovisionnement (
    ...
    CONSTRAINT demandes_reapprovisionnement_statut_check CHECK (((statut)::text = ANY (ARRAY[('brouillon'::character varying)::text, ('envoyee'::character varying)::text, ('approuvee'::character varying)::text, ('partiellement_approuvee'::character varying)::text, ('refusee'::character varying)::text, ('en_cours'::character varying)::text, ('livree'::character varying)::text, ('cloturee'::character varying)::text])))
);


--
-- Name: TABLE demandes_reapprovisionnement; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN demandes_reapprovisionnement.statut; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement_history; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE demandes_reapprovisionnement_history; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement_history_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement_history_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement_lignes; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE demandes_reapprovisionnement_lignes; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement_lignes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement_lignes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: depense_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: TABLE depenses; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN depenses.location_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN depenses.session_caisse_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN depenses.magasin_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN depenses.mouvement_caisse_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN depenses.beneficiaire_libre; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN depenses.deleted_at; Type: COMMENT; Schema: public; Owner: -
--
...
CREATE TABLE public.devis (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT devis_statut_check CHECK (((statut)::text = ANY (ARRAY[('brouillon'::character varying)::text, ('envoye'::character varying)::text, ('accepte'::character varying)::text, ('refuse'::character varying)::text, ('annule'::character varying)::text, ('converti'::character varying)::text])))
);
...
--
-- Name: devis_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: devis_lignes; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: devis_lignes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: devis_lignes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: devis_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: document_lignes; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: document_lignes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: document_lignes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.ecritures_comptables (
    ...
    libelle text,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    compte_numero character varying(8),
    tiers_id integer,
    reference_type character varying(50),
    reference_id integer,
    cree_par integer,
    date_saisie timestamp with time zone DEFAULT now(),
    CONSTRAINT chk_ecritures_single_side CHECK ((NOT ((debit > (0)::numeric) AND (credit > (0)::numeric)))),
    ...
    CONSTRAINT ecritures_comptables_journal_check CHECK (((journal)::text = ANY (ARRAY[('ACHATS'::character varying)::text, ('VENTES'::character varying)::text, ('TRESORERIE'::character varying)::text, ('OD'::character varying)::text])))
);
...
--
-- Name: facture_avoir_lignes; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: facture_avoir_lignes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: facture_avoir_lignes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: facture_fournisseur_lignes; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: facture_fournisseur_lignes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: facture_fournisseur_lignes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: facture_fournisseur_numero_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: facture_numero_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
CREATE TABLE public.factures (
    ...
    remise_globale_pct numeric(5,2) DEFAULT 0.00,
    magasin_id integer,
    CONSTRAINT factures_statut_check CHECK (((statut)::text = ANY (ARRAY[('payee'::character varying)::text, ('partielle'::character varying)::text, ('en_attente'::character varying)::text, ('annulee'::character varying)::text]))),
    CONSTRAINT factures_tva_zero CHECK ((tva = (0)::numeric)),
    CONSTRAINT factures_type_facture_check CHECK (((type_facture)::text = ANY (ARRAY[('standard'::character varying)::text, ('avoir'::character varying)::text, ('echange'::character varying)::text])))
);


--
-- Name: factures_avoir; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.factures_avoir (
    ...
    CONSTRAINT factures_avoir_avoir_type_check CHECK (((avoir_type)::text = ANY (ARRAY[('retour'::character varying)::text, ('echange'::character varying)::text, ('remise_commerciale'::character varying)::text, ('erreur'::character varying)::text]))),
    CONSTRAINT factures_avoir_statut_check CHECK (((statut)::text = ANY (ARRAY[('brouillon'::character varying)::text, ('valide'::character varying)::text, ('annule'::character varying)::text, ('utilise'::character varying)::text])))
);


--
-- Name: factures_avoir_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: factures_avoir_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.factures_fournisseur (
    ...
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    commande_id integer,
    CONSTRAINT factures_fournisseur_statut_check CHECK (((statut)::text = ANY (ARRAY[('en_attente'::character varying)::text, ('validee'::character varying)::text, ('partiellement_payee'::character varying)::text, ('payee'::character varying)::text, ('annulee'::character varying)::text])))
);


--
-- Name: factures_fournisseur_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: factures_fournisseur_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: internal_request_numero_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: internal_stock_request_lignes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: internal_stock_request_lignes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: internal_stock_requests_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: internal_stock_requests_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: magasins; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE magasins; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN magasins.location_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: magasins_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: magasins_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.mouvements_caisse (
    ...
    CONSTRAINT chk_mouvement_source CHECK ((((reference_type IS NOT NULL) AND (reference_id IS NOT NULL)) OR ((categorie)::text = ANY (ARRAY[('apport'::character varying)::text, ('retrait_banque'::character varying)::text, ('autre_entree'::character varying)::text, ('autre_sortie'::character varying)::text])))),
    CONSTRAINT chk_mouvements_caisse_montant_pos CHECK ((montant > (0)::numeric)),
    CONSTRAINT mouvements_caisse_categorie_check CHECK (((categorie)::text = ANY (ARRAY[('paiement_client'::character varying)::text, ('acompte_client'::character varying)::text, ('apport'::character varying)::text, ('autre_entree'::character varying)::text, ('depense'::character varying)::text, ('paiement_fournisseur'::character varying)::text, ('retrait_banque'::character varying)::text, ('remboursement_client'::character varying)::text, ('autre_sortie'::character varying)::text]))),
    CONSTRAINT mouvements_caisse_methode_paiement_check CHECK (((methode_paiement)::text = ANY (ARRAY[('espece'::character varying)::text, ('carte'::character varying)::text, ('cheque'::character varying)::text, ('virement'::character varying)::text, ('mobile_money'::character varying)::text, ('orange_money'::character varying)::text, ('mtn_money'::character varying)::text, ('wave'::character varying)::text]))),
    CONSTRAINT mouvements_caisse_reference_type_check CHECK (((reference_type)::text = ANY (ARRAY[('paiement'::character varying)::text, ('acompte'::character varying)::text, ('acompte_fournisseur'::character varying)::text, ('depense'::character varying)::text, ('paiement_fournisseur'::character varying)::text, ('avoir'::character varying)::text, ('apport'::character varying)::text, ('retrait'::character varying)::text]))),
    CONSTRAINT mouvements_caisse_type_check CHECK (((type)::text = ANY (ARRAY[('encaissement'::character varying)::text, ('decaissement'::character varying)::text]))),
    CONSTRAINT mouvements_caisse_type_mouvement_check CHECK (((type_mouvement)::text = ANY (ARRAY[('vente'::character varying)::text, ('remise'::character varying)::text, ('sortie'::character varying)::text, ('entree_autre'::character varying)::text])))
);


--
-- Name: TABLE mouvements_caisse; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN mouvements_caisse.type; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN mouvements_caisse.categorie; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN mouvements_caisse.reference_type; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN mouvements_caisse.reference_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN mouvements_caisse.libelle; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN mouvements_caisse.solde_apres; Type: COMMENT; Schema: public; Owner: -
--
...
CREATE TABLE public.mouvements_stock (
    ...
    location_id integer,
    transfer_id integer,
    CONSTRAINT mouvements_stock_type_mouvement_check CHECK (((type_mouvement)::text = ANY (ARRAY[('vente'::character varying)::text, ('ajustement'::character varying)::text, ('retour'::character varying)::text, ('commande'::character varying)::text, ('perte'::character varying)::text, ('autre'::character varying)::text, ('transfert'::character varying)::text])))
);
...
CREATE TABLE public.paiements (
    ...
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    deleted_at timestamp without time zone,
    CONSTRAINT chk_paiement_source CHECK (((source)::text = ANY (ARRAY[('direct'::character varying)::text, ('acompte_application'::character varying)::text, ('reversal'::character varying)::text]))),
    CONSTRAINT chk_paiements_montant_pos CHECK ((montant > (0)::numeric)),
    CONSTRAINT paiements_methode_paiement_check CHECK (((methode_paiement)::text = ANY (ARRAY[('espece'::character varying)::text, ('carte'::character varying)::text, ('cheque'::character varying)::text, ('virement'::character varying)::text, ('mobile_money'::character varying)::text, ('orange_money'::character varying)::text, ('mtn_money'::character varying)::text, ('wave'::character varying)::text])))
);


--
-- Name: COLUMN paiements.session_caisse_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN paiements.magasin_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: paiements_fournisseur; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: COLUMN paiements_fournisseur.magasin_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: paiements_fournisseur_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: paiements_fournisseur_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: payroll_bareme_its; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.payroll_bareme_its (
    id integer NOT NULL,
    ordre integer NOT NULL,
    tranche_min numeric(15,2) DEFAULT 0 NOT NULL,
    tranche_max numeric(15,2),
...
--
-- Name: payroll_bareme_its_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.payroll_bareme_its_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: payroll_bareme_its_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.payroll_bareme_its_id_seq OWNED BY public.payroll_bareme_its.id;


--
-- Name: payroll_cotisations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.payroll_cotisations (
    id integer NOT NULL,
    code character varying(20) NOT NULL,
    libelle character varying(120) NOT NULL,
    taux_salarial numeric(6,4) DEFAULT 0 NOT NULL,
    taux_patronal numeric(6,4) DEFAULT 0 NOT NULL,
...
--
-- Name: payroll_cotisations_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.payroll_cotisations_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: payroll_cotisations_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.payroll_cotisations_id_seq OWNED BY public.payroll_cotisations.id;


--
-- Name: payroll_run_numero_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.payroll_run_numero_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.payroll_runs (
    ...
    total_brut numeric(15,2) DEFAULT 0 NOT NULL,
    total_commissions numeric(15,2) DEFAULT 0 NOT NULL,
    total_primes numeric(15,2) DEFAULT 0 NOT NULL,
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    total_cnps numeric(15,2) DEFAULT 0 NOT NULL,
    total_its numeric(15,2) DEFAULT 0 NOT NULL,
    total_charges_patronales numeric(15,2) DEFAULT 0 NOT NULL,
    CONSTRAINT payroll_runs_statut_check CHECK (((statut)::text = ANY ((ARRAY['brouillon'::character varying, 'valide'::character varying, 'paye'::character varying, 'annule'::character varying])::text[])))
);
...
CREATE TABLE public.payslips (
    ...
    employe_id integer NOT NULL,
    salaire_base numeric(15,2) DEFAULT 0 NOT NULL,
    commissions numeric(15,2) DEFAULT 0 NOT NULL,
    primes numeric(15,2) DEFAULT 0 NOT NULL,
    deductions numeric(15,2) DEFAULT 0 NOT NULL,
    salaire_brut numeric(15,2) DEFAULT 0 NOT NULL,
    salaire_net numeric(15,2) DEFAULT 0 NOT NULL,
    statut character varying(20) DEFAULT 'en_attente'::character varying NOT NULL,
    methode_paiement character varying(30),
    date_paiement timestamp without time zone,
    notes text,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    retenue_cnps numeric(15,2) DEFAULT 0 NOT NULL,
    retenue_its numeric(15,2) DEFAULT 0 NOT NULL,
    cotisations_patronales numeric(15,2) DEFAULT 0 NOT NULL,
    CONSTRAINT payslips_statut_check CHECK (((statut)::text = ANY ((ARRAY['en_attente'::character varying, 'paye'::character varying])::text[])))
);
...
CREATE TABLE public.periodes_comptables (
    ...
    CONSTRAINT periodes_comptables_statut_check CHECK (((statut)::text = ANY (ARRAY[('ouverte'::character varying)::text, ('fermee'::character varying)::text])))
);


--
-- Name: periodes_comptables_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: periodes_comptables_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: piece_comptable_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.piece_comptable_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.plan_comptable (
    ...
    compte_parent character varying(8),
    CONSTRAINT plan_comptable_classe_check CHECK (((classe >= 1) AND (classe <= 9))),
    CONSTRAINT plan_comptable_type_compte_check CHECK (((type_compte)::text = ANY (ARRAY[('actif'::character varying)::text, ('passif'::character varying)::text, ('capitaux_propres'::character varying)::text, ('charge'::character varying)::text, ('produit'::character varying)::text])))
);


--
-- Name: plan_comptable_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: plan_comptable_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: pos_cart_items; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE pos_cart_items; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: pos_cart_items_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: pos_cart_items_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.pos_sessions (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    location_id integer,
    CONSTRAINT pos_sessions_statut_check CHECK (((statut)::text = ANY (ARRAY[('ouverte'::character varying)::text, ('fermee'::character varying)::text])))
);
...
--
-- Name: COLUMN pos_sessions.location_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN produits.stock; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN produits.image_url; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN produits.image_thumbnail; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN produits.suivi_lot; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN produits.suivi_serial; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN produits.garantie_mois; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: ravitaillement_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.ravitaillement_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: reception_numero_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: COLUMN receptions.location_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: retour_lignes; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: retour_lignes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: retour_lignes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: retour_numero_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.retour_numero_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: retours; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.retours (
    ...
    cree_par integer,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT retours_statut_check CHECK (((statut)::text = ANY (ARRAY[('en_attente'::character varying)::text, ('traite'::character varying)::text, ('annule'::character varying)::text])))
);


--
-- Name: retours_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: retours_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: sessions_caisse; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.sessions_caisse (
    ...
    CONSTRAINT sessions_caisse_statut_check CHECK (((statut)::text = ANY (ARRAY[('ouverte'::character varying)::text, ('cloturee'::character varying)::text])))
);


--
-- Name: TABLE sessions_caisse; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN sessions_caisse.ecart; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN sessions_caisse.magasin_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN sessions_caisse.ouverte_par_user_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN sessions_caisse.cloturee_par_user_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN sessions_caisse.fond_initial; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN sessions_caisse.fond_final_compte; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN sessions_caisse.solde_theorique_cloture; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN sessions_caisse.commentaire_cloture; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: sessions_caisse_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: sessions_caisse_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: shifts_employes; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.shifts_employes (
    ...
    notes text,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT shifts_employes_statut_check CHECK (((statut)::text = ANY (ARRAY[('prevu'::character varying)::text, ('en_cours'::character varying)::text, ('termine'::character varying)::text, ('absent'::character varying)::text])))
);


--
-- Name: shifts_employes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: shifts_employes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.stock_locations (
    ...
    CONSTRAINT stock_locations_location_type_check CHECK (((location_type)::text = ANY (ARRAY[('depot'::character varying)::text, ('magasin'::character varying)::text])))
);
...
--
-- Name: stock_par_location; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.stock_par_location (
    ...
    cmp numeric(15,2) DEFAULT 0,
    CONSTRAINT stock_par_location_quantite_check CHECK ((quantite >= 0))
);


--
-- Name: stock_par_location_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: stock_par_location_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: stock_transfer_lignes; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: stock_transfer_lignes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: stock_transfer_lignes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: taux_tva; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE taux_tva; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: taux_tva_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: taux_tva_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: three_way_match_config; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.three_way_match_config (
    id integer DEFAULT 1 NOT NULL,
    qte_tolerance_pct numeric(6,4) DEFAULT 0.0000 NOT NULL,
    prix_tolerance_pct numeric(6,4) DEFAULT 0.0500 NOT NULL,
    bloquer boolean DEFAULT false NOT NULL,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT three_way_match_config_id_check CHECK ((id = 1))
);


--
-- Name: three_way_match_details_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: three_way_match_details_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: TABLE tiers; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN tiers.est_client; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN tiers.est_fournisseur; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN tiers.solde_client_actuel; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN tiers.solde_fournisseur_actuel; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: transfer_numero_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: transfert_caisse_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: transferts_caisse; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.transferts_caisse (
    ...
    CONSTRAINT transferts_caisse_statut_check CHECK (((statut)::text = ANY (ARRAY[('en_attente'::character varying)::text, ('valide'::character varying)::text, ('annule'::character varying)::text])))
);


--
-- Name: TABLE transferts_caisse; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: transferts_caisse_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: transferts_caisse_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.user_location_roles (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT user_location_roles_role_at_location_check CHECK (((role_at_location)::text = ANY (ARRAY[('depot_staff'::character varying)::text, ('magasin_staff'::character varying)::text, ('both'::character varying)::text])))
);


--
-- Name: user_location_roles_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: user_location_roles_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: utilisateur_locations; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE utilisateur_locations; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN utilisateur_locations.est_defaut; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: utilisateur_locations_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: utilisateur_locations_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: v_caisse_audit; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: VIEW v_caisse_audit; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: v_demandes_reapprovisionnement; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: VIEW v_demandes_reapprovisionnement; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: vue_session_methode_totaux; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: VIEW vue_session_methode_totaux; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_internal_stock_request_lignes id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_internal_stock_requests id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_three_way_match_details_2026_05 id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_three_way_matches_2026_05 id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications_fournisseur id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: acomptes_clients id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: acomptes_fournisseur id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: allocation_audit id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: barcode_scans id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: bon_livraison_lignes id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: bons_livraison id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: commandes_fournisseur id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: commissions_ventes id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commissions_ventes ALTER COLUMN id SET DEFAULT nextval('public.commissions_ventes_id_seq'::regclass);
...
--
-- Name: compte_client_lignes id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: compte_fournisseur_lignes id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: crm_taches id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.crm_taches ALTER COLUMN id SET DEFAULT nextval('public.crm_taches_id_seq'::regclass);


--
-- Name: demandes_reapprovisionnement id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement_history id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement_lignes id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: devis id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: devis_lignes id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: document_lignes id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: facture_avoir_lignes id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: facture_fournisseur_lignes id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: factures_avoir id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: factures_fournisseur id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: magasins id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: paiements_fournisseur id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: payroll_bareme_its id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payroll_bareme_its ALTER COLUMN id SET DEFAULT nextval('public.payroll_bareme_its_id_seq'::regclass);


--
-- Name: payroll_cotisations id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payroll_cotisations ALTER COLUMN id SET DEFAULT nextval('public.payroll_cotisations_id_seq'::regclass);
...
--
-- Name: periodes_comptables id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: plan_comptable id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: pos_cart_items id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: retour_lignes id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: retours id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: sessions_caisse id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: shifts_employes id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: stock_par_location id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: stock_transfer_lignes id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: taux_tva id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: transferts_caisse id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: user_location_roles id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: utilisateur_locations id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications_fournisseur acompte_applications_fournisseur_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications acompte_applications_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acomptes_clients acomptes_clients_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acomptes_fournisseur acomptes_fournisseur_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: bon_livraison_lignes bon_livraison_lignes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: bons_livraison bons_livraison_numero_bl_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: bons_livraison bons_livraison_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: caisses caisses_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: categories_depenses categories_depenses_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: paiements chk_paiement_acompte_no_session; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: paiements chk_paiement_espece_session; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: commandes_fournisseur commandes_fournisseur_numero_commande_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: commandes_fournisseur commandes_fournisseur_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: commissions_ventes commissions_ventes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commissions_ventes
    ADD CONSTRAINT commissions_ventes_pkey PRIMARY KEY (id);
...
--
-- Name: compte_client_lignes compte_client_lignes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: compte_fournisseur_lignes compte_fournisseur_lignes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crm_taches crm_taches_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.crm_taches
    ADD CONSTRAINT crm_taches_pkey PRIMARY KEY (id);


--
-- Name: demandes_reapprovisionnement_history demandes_reapprovisionnement_history_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement_lignes demandes_reapprovisionnement_lignes_demande_id_produit_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement_lignes demandes_reapprovisionnement_lignes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement demandes_reapprovisionnement_numero_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement demandes_reapprovisionnement_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: depenses depenses_numero_depense_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: devis_lignes devis_lignes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: devis devis_numero_devis_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: document_lignes document_lignes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employes employes_matricule_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employes employes_utilisateur_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: facture_avoir_lignes facture_avoir_lignes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: facture_fournisseur_lignes facture_fournisseur_lignes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures_avoir factures_avoir_numero_avoir_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures_avoir factures_avoir_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures_fournisseur factures_fournisseur_numero_facture_interne_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures_fournisseur factures_fournisseur_tiers_id_numero_facture_fournisseur_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures factures_numero_facture_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_internal_stock_request_lignes internal_stock_request_lignes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_internal_stock_request_lignes internal_stock_request_lignes_request_id_produit_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_internal_stock_requests internal_stock_requests_numero_demande_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_internal_stock_requests internal_stock_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: magasins magasins_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: magasins magasins_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: paiements_fournisseur paiements_fournisseur_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payroll_bareme_its payroll_bareme_its_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payroll_bareme_its
    ADD CONSTRAINT payroll_bareme_its_pkey PRIMARY KEY (id);


--
-- Name: payroll_cotisations payroll_cotisations_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payroll_cotisations
    ADD CONSTRAINT payroll_cotisations_code_key UNIQUE (code);


--
-- Name: payroll_cotisations payroll_cotisations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payroll_cotisations
    ADD CONSTRAINT payroll_cotisations_pkey PRIMARY KEY (id);


--
-- Name: payroll_runs payroll_runs_numero_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payroll_runs
    ADD CONSTRAINT payroll_runs_numero_key UNIQUE (numero);
...
--
-- Name: payslips payslips_payroll_run_id_employe_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payslips
    ADD CONSTRAINT payslips_payroll_run_id_employe_id_key UNIQUE (payroll_run_id, employe_id);
...
--
-- Name: periodes_comptables periodes_comptables_exercice_periode_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: plan_comptable plan_comptable_numero_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pos_cart_items pos_cart_items_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: produits produits_code_barre_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: produits produits_reference_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: receptions receptions_numero_reception_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: retour_lignes retour_lignes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: retours retours_numero_retour_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: retours retours_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sessions_caisse sessions_caisse_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: shifts_employes shifts_employes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: stock_par_location stock_par_location_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: stock_par_location stock_par_location_produit_id_location_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: stock_transfer_lignes stock_transfer_lignes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: stock_transfer_lignes stock_transfer_lignes_transfer_id_produit_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: stock_transfers stock_transfers_numero_transfer_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: taux_tva taux_tva_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: taux_tva taux_tva_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: three_way_match_config three_way_match_config_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.three_way_match_config
    ADD CONSTRAINT three_way_match_config_pkey PRIMARY KEY (id);


--
-- Name: _deprecated_three_way_match_details_2026_05 three_way_match_details_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_three_way_matches_2026_05 three_way_matches_commande_id_reception_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_three_way_matches_2026_05 three_way_matches_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tiers tiers_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: transferts_caisse transferts_caisse_numero_transfert_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: transferts_caisse transferts_caisse_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_location_roles user_location_roles_utilisateur_id_location_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: utilisateur_locations utilisateur_locations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: utilisateur_locations utilisateur_locations_utilisateur_id_location_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_3wm_commande; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_3wm_facture; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_3wm_reception; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_3wm_statut; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_acompte_app_acompte; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_acompte_app_facture; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_acompte_app_fourn_acompte; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_acompte_app_fourn_facture; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_acompte_app_fourn_paiement; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_acompte_app_paiement; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_acomptes_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_acomptes_facture_applique; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_acomptes_facture_applique ON public.acomptes_clients USING btree (facture_id_applique);


--
-- Name: idx_acomptes_fourn_mouvement; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_acomptes_fourn_restant; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_acomptes_fourn_session; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_acomptes_fourn_statut; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_acomptes_fourn_tiers; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_acomptes_magasin; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_acomptes_restant; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_acomptes_session; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_acomptes_session ON public.acomptes_clients USING btree (session_caisse_id);


--
-- Name: idx_acomptes_statut; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_acomptes_tiers; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_alloc_audit_tiers; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_avoir_deleted; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_avoir_facture; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_avoir_lignes_avoir; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_avoir_tiers; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_barcode_scans_code; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_barcode_scans_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_barcode_scans_produit; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bl_deleted; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bl_lignes_bl; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bl_statut; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_bl_tiers; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_caisses_location; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_caisses_parent; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_caisses_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ccl_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ccl_document; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ccl_tiers; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ccl_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cfl_tiers; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cfl_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_commande_deleted; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_commande_lignes_commande; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_commande_lignes_produit; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_commande_lignes_produit ON public.commande_lignes USING btree (produit_id);


--
-- Name: idx_commande_statut; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_commande_tiers; Type: INDEX; Schema: public; Owner: -
--
...
CREATE INDEX idx_commissions_date ON public.commissions_ventes USING btree (date_vente);


--
-- Name: idx_commissions_employe; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_commissions_employe ON public.commissions_ventes USING btree (employe_id);


--
-- Name: idx_commissions_facture; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_commissions_facture ON public.commissions_ventes USING btree (facture_id);


--
-- Name: idx_comp_statut; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_comp_tiers; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_crm_date_rappel; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_crm_date_rappel ON public.crm_interactions USING btree (date_rappel);


--
-- Name: idx_crm_statut; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_crm_statut ON public.crm_interactions USING btree (statut);


--
-- Name: idx_crm_taches_assigne; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_crm_taches_assigne ON public.crm_taches USING btree (assigne_a);


--
-- Name: idx_crm_taches_statut; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_crm_taches_statut ON public.crm_taches USING btree (statut);


--
-- Name: idx_crm_taches_tiers; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_crm_taches_tiers ON public.crm_taches USING btree (tiers_id);


--
-- Name: idx_crm_tiers_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_crm_tiers_id ON public.crm_interactions USING btree (tiers_id);


--
-- Name: idx_crm_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_crm_type ON public.crm_interactions USING btree (type);


--
-- Name: idx_demandes_created_by; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_demandes_date_creation; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_demandes_depot; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_demandes_depot_statut; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_demandes_history_demande; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_demandes_history_timestamp; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_demandes_lignes_demande; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_demandes_lignes_produit; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_demandes_magasin; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_demandes_magasin_statut; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_demandes_statut; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_demandes_transfert; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_depenses_deleted_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_depenses_fournisseur; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_depenses_location; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_depenses_magasin; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_depenses_methode; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_depenses_mouvement; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_depenses_session; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_devis_deleted; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_devis_lignes_devis; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_devis_statut; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_devis_tiers; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_document_lignes_lookup; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_document_lignes_produit; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ecriture_compte; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ecriture_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ecriture_journal; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ecriture_piece; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ecritures_tiers; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ecritures_tiers ON public.ecritures_comptables USING btree (tiers_id) WHERE (tiers_id IS NOT NULL);


--
-- Name: idx_employes_actif; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_employes_matricule; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_employes_utilisateur; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_facture_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_facture_deleted; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_facture_echeance; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_facture_statut; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_facture_tiers; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_factures_avoir_appliquee; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_factures_avoir_deleted_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_factures_bl_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_factures_devis_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_factures_magasin; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_factures_tiers_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ff_commande; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ff_commande ON public.factures_fournisseur USING btree (commande_id);


--
-- Name: idx_ff_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ff_date ON public.factures_fournisseur USING btree (date_facture DESC);


--
-- Name: idx_ff_echeance; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ff_statut; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ff_tiers; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_internal_request_lignes_produit; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_internal_request_lignes_request; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_internal_requests_created_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_internal_requests_depot; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_internal_requests_magasin; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_internal_requests_statut; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_magasins_code; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_magasins_location; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mouvement_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mouvement_produit; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mouvement_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mouvements_categorie; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mouvements_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mouvements_location; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mouvements_magasin_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mouvements_reference; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mouvements_session_caisse; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mouvements_session_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mouvements_stock_produit_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mouvements_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_paiement_ff; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_paiements_date_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_paiements_facture; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_paiements_fourn_source; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_paiements_fournisseur_magasin; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_paiements_magasin; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_paiements_session; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_paiements_source; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payroll_runs_periode; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_payroll_runs_periode ON public.payroll_runs USING btree (periode);


--
-- Name: idx_payslips_employe; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_payslips_employe ON public.payslips USING btree (employe_id);
...
--
-- Name: idx_pos_cart_produit; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_pos_cart_session; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_pos_sessions_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_pos_sessions_location; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_pos_sessions_statut; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_pos_sessions_utilisateur; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_produit_categorie; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_produit_fournisseur; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_produit_nom; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_produit_reference; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_produits_categorie_trgm; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_produits_code_barre; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_produits_deleted_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_produits_description_trgm; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_produits_image; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_produits_nom_trgm; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_produits_reference_trgm; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_reception_lignes_reception; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_receptions_commande; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_receptions_location; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_retour_lignes_facture_produit; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_retour_lignes_facture_produit ON public.retour_lignes USING btree (facture_id, produit_id);


--
-- Name: idx_retour_lignes_retour; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_retours_statut; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_retours_tiers; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_sessions_caisse_caisse; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sessions_caisse_caisse ON public.sessions_caisse USING btree (caisse_id);


--
-- Name: idx_sessions_cloturee_par; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_sessions_date_cloture; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_sessions_date_ouverture; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_sessions_magasin; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_sessions_ouverte_par; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_sessions_statut; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_sessions_une_ouverte_par_magasin; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_shifts_employe; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_stock_location_location; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_stock_location_produit; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_stock_transfer_lignes_demande_ligne; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_stock_transfers_demande; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_taux_tva_actif; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tiers_code; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tiers_deleted_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tiers_est_client; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tiers_est_fournisseur; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tiers_nif; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tiers_raison_sociale; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_transfer_statut; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_transferts_dest; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_transferts_source; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_transferts_statut; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_user_location_roles_location; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_user_location_roles_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_utilisateur_locations_location; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_utilisateur_locations_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_utilisateurs_username; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: uq_acomptes_fourn_idempotency; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: uq_acomptes_idempotency; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: uq_mouvements_idempotency; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: uq_paiements_fourn_idempotency; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: uq_paiements_idempotency; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications trg_acompte_app_cap; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications_fournisseur trg_acompte_fourn_cap; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications_fournisseur trg_acompte_fourn_sync; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: paiements trg_after_payment_insert; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: crm_interactions trg_crm_interactions_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_crm_interactions_updated BEFORE UPDATE ON public.crm_interactions FOR EACH ROW EXECUTE FUNCTION public.update_crm_timestamp();


--
-- Name: crm_taches trg_crm_taches_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_crm_taches_updated BEFORE UPDATE ON public.crm_taches FOR EACH ROW EXECUTE FUNCTION public.update_crm_timestamp();


--
-- Name: demandes_reapprovisionnement trg_demande_state_change; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: factures trg_facture_client_ecriture; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: factures_fournisseur trg_facture_fournisseur_ecriture; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: factures trg_facture_ht_ttc; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: mouvements_caisse trg_mouvement_append_only; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: mouvements_caisse trg_mouvement_magasin_coherence; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: paiements trg_paiement_espece_mouvement; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: paiements_fournisseur trg_paiement_ff_iud; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: stock_par_location trg_stock_valeur_invariant; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_stock_valeur_invariant BEFORE INSERT OR UPDATE OF quantite, cmp, valeur_stock ON public.stock_par_location FOR EACH ROW EXECUTE FUNCTION public.enforce_stock_valeur_invariant();


--
-- Name: acompte_applications trg_sync_acompte_after_app; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: stock_par_location trg_sync_cmp; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_sync_cmp AFTER UPDATE OF cmp ON public.stock_par_location FOR EACH ROW WHEN (((new.cmp IS DISTINCT FROM old.cmp) AND (new.cmp > (0)::numeric))) EXECUTE FUNCTION public.sync_cmp_to_produit();


--
-- Name: stock_transfers trg_sync_demande_transfer; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: stock_par_location trg_sync_produits_stock; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: tiers trg_tiers_code; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: bons_livraison update_bons_livraison_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: caisses update_caisses_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement_lignes update_demandes_lignes_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement update_demandes_reapprovisionnement_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: depenses update_depenses_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: devis update_devis_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: employes update_employes_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: factures_avoir update_factures_avoir_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: factures_fournisseur update_factures_fournisseur_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: magasins update_magasins_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: mouvements_caisse update_mouvements_caisse_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: sessions_caisse update_sessions_caisse_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: stock_locations update_stock_locations_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: stock_par_location update_stock_par_location_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: tiers update_tiers_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: utilisateurs update_utilisateurs_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications acompte_applications_acompte_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications acompte_applications_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications acompte_applications_facture_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications_fournisseur acompte_applications_fournisseur_acompte_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications_fournisseur acompte_applications_fournisseur_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications_fournisseur acompte_applications_fournisseur_facture_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications_fournisseur acompte_applications_fournisseur_paiement_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acompte_applications acompte_applications_paiement_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acomptes_clients acomptes_clients_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acomptes_clients acomptes_clients_facture_id_applique_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acomptes_clients acomptes_clients_magasin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acomptes_clients acomptes_clients_mouvement_caisse_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acomptes_clients acomptes_clients_rembourse_par_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acomptes_clients acomptes_clients_session_caisse_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acomptes_fournisseur acomptes_fournisseur_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acomptes_fournisseur acomptes_fournisseur_facture_id_applique_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acomptes_fournisseur acomptes_fournisseur_magasin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acomptes_fournisseur acomptes_fournisseur_mouvement_caisse_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acomptes_fournisseur acomptes_fournisseur_rembourse_par_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acomptes_fournisseur acomptes_fournisseur_session_caisse_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: allocation_audit allocation_audit_tiers_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: attachments attachments_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.attachments
    ADD CONSTRAINT attachments_cree_par_fkey FOREIGN KEY (cree_par) REFERENCES public.utilisateurs(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.audit_log
    ADD CONSTRAINT audit_log_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.utilisateurs(id) ON DELETE SET NULL;


--
-- Name: barcode_scans barcode_scans_produit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: barcode_scans barcode_scans_utilisateur_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: bon_livraison_lignes bon_livraison_lignes_bl_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: bon_livraison_lignes bon_livraison_lignes_produit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: bons_livraison bons_livraison_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: bons_livraison bons_livraison_devis_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: bons_livraison bons_livraison_facture_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: bons_livraison bons_livraison_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: bons_livraison bons_livraison_tiers_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: caisses caisses_caisse_parent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: caisses caisses_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: categories_depenses categories_depenses_compte_comptable_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: commande_lignes commande_lignes_commande_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: commande_lignes commande_lignes_produit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: commandes_fournisseur commandes_fournisseur_tiers_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: commissions_ventes commissions_ventes_employe_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commissions_ventes
    ADD CONSTRAINT commissions_ventes_employe_id_fkey FOREIGN KEY (employe_id) REFERENCES public.employes(id) ON DELETE RESTRICT;


--
-- Name: commissions_ventes commissions_ventes_facture_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commissions_ventes
    ADD CONSTRAINT commissions_ventes_facture_id_fkey FOREIGN KEY (facture_id) REFERENCES public.factures(id) ON DELETE RESTRICT;


--
-- Name: compensations compensations_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: compensations compensations_ecriture_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: compensations compensations_tiers_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: compte_client_lignes compte_client_lignes_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: compte_fournisseur_lignes compte_fournisseur_lignes_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: compte_fournisseur_lignes compte_fournisseur_lignes_tiers_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crm_interactions crm_interactions_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.crm_interactions
    ADD CONSTRAINT crm_interactions_cree_par_fkey FOREIGN KEY (cree_par) REFERENCES public.utilisateurs(id);


--
-- Name: crm_interactions crm_interactions_tiers_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.crm_interactions
    ADD CONSTRAINT crm_interactions_tiers_id_fkey FOREIGN KEY (tiers_id) REFERENCES public.tiers(id) ON DELETE CASCADE;


--
-- Name: crm_taches crm_taches_assigne_a_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.crm_taches
    ADD CONSTRAINT crm_taches_assigne_a_fkey FOREIGN KEY (assigne_a) REFERENCES public.utilisateurs(id);


--
-- Name: crm_taches crm_taches_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.crm_taches
    ADD CONSTRAINT crm_taches_cree_par_fkey FOREIGN KEY (cree_par) REFERENCES public.utilisateurs(id);


--
-- Name: crm_taches crm_taches_tiers_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.crm_taches
    ADD CONSTRAINT crm_taches_tiers_id_fkey FOREIGN KEY (tiers_id) REFERENCES public.tiers(id) ON DELETE CASCADE;


--
-- Name: demandes_reapprovisionnement demandes_reapprovisionnement_closed_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement demandes_reapprovisionnement_created_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement demandes_reapprovisionnement_decided_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement demandes_reapprovisionnement_depot_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement demandes_reapprovisionnement_executed_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement_history demandes_reapprovisionnement_history_demande_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement_history demandes_reapprovisionnement_history_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement_lignes demandes_reapprovisionnement_lignes_demande_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement_lignes demandes_reapprovisionnement_lignes_produit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement demandes_reapprovisionnement_magasin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: demandes_reapprovisionnement demandes_reapprovisionnement_transfert_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: depenses depenses_categorie_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: depenses depenses_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: depenses depenses_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: depenses depenses_magasin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: depenses depenses_mouvement_caisse_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: depenses depenses_session_caisse_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: depenses depenses_tiers_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: devis devis_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: devis devis_facture_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: devis_lignes devis_lignes_devis_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: devis_lignes devis_lignes_produit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: devis devis_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: devis devis_tiers_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: document_lignes document_lignes_parent_ligne_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: document_lignes document_lignes_produit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ecritures_comptables ecritures_comptables_compte_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ecritures_comptables ecritures_comptables_tiers_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ecritures_comptables
    ADD CONSTRAINT ecritures_comptables_tiers_id_fkey FOREIGN KEY (tiers_id) REFERENCES public.tiers(id);


--
-- Name: employes employes_utilisateur_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: facture_avoir_lignes facture_avoir_lignes_avoir_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: facture_avoir_lignes facture_avoir_lignes_produit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: facture_avoir_lignes facture_avoir_lignes_taux_tva_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: facture_fournisseur_lignes facture_fournisseur_lignes_facture_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: facture_fournisseur_lignes facture_fournisseur_lignes_produit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures_avoir factures_avoir_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures_avoir factures_avoir_facture_appliquee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures_avoir factures_avoir_facture_origine_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures_avoir factures_avoir_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures_avoir factures_avoir_retour_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures_avoir factures_avoir_tiers_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures factures_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures_fournisseur factures_fournisseur_commande_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures_fournisseur factures_fournisseur_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures_fournisseur factures_fournisseur_reception_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures_fournisseur factures_fournisseur_tiers_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures factures_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures factures_magasin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures factures_modifie_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: factures factures_tiers_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: acomptes_clients fk_acomptes_clients_tiers_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.acomptes_clients
    ADD CONSTRAINT fk_acomptes_clients_tiers_id FOREIGN KEY (tiers_id) REFERENCES public.tiers(id) ON DELETE RESTRICT;


--
-- Name: acomptes_fournisseur fk_acomptes_fournisseur_tiers_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.acomptes_fournisseur
    ADD CONSTRAINT fk_acomptes_fournisseur_tiers_id FOREIGN KEY (tiers_id) REFERENCES public.tiers(id) ON DELETE RESTRICT;


--
-- Name: compte_client_lignes fk_compte_client_lignes_tiers_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.compte_client_lignes
    ADD CONSTRAINT fk_compte_client_lignes_tiers_id FOREIGN KEY (tiers_id) REFERENCES public.tiers(id) ON DELETE RESTRICT;


--
-- Name: ecritures_comptables fk_ecritures_compte_numero; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ecritures_comptables
    ADD CONSTRAINT fk_ecritures_compte_numero FOREIGN KEY (compte_numero) REFERENCES public.plan_comptable(numero);


--
-- Name: mouvements_caisse fk_mouvements_caisse_session_caisse_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mouvements_caisse
    ADD CONSTRAINT fk_mouvements_caisse_session_caisse_id FOREIGN KEY (session_caisse_id) REFERENCES public.sessions_caisse(id) ON DELETE RESTRICT;


--
-- Name: mouvements_stock fk_mouvements_stock_produit_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mouvements_stock
    ADD CONSTRAINT fk_mouvements_stock_produit_id FOREIGN KEY (produit_id) REFERENCES public.produits(id) ON DELETE RESTRICT;


--
-- Name: paiements fk_paiements_facture_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.paiements
    ADD CONSTRAINT fk_paiements_facture_id FOREIGN KEY (facture_id) REFERENCES public.factures(id) ON DELETE RESTRICT;


--
-- Name: paiements_fournisseur fk_paiements_fournisseur_facture_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.paiements_fournisseur
    ADD CONSTRAINT fk_paiements_fournisseur_facture_id FOREIGN KEY (facture_id) REFERENCES public.factures_fournisseur(id) ON DELETE RESTRICT;


--
-- Name: _deprecated_internal_stock_request_lignes internal_stock_request_lignes_produit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_internal_stock_request_lignes internal_stock_request_lignes_request_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_internal_stock_requests internal_stock_requests_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_internal_stock_requests internal_stock_requests_depot_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_internal_stock_requests internal_stock_requests_execute_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_internal_stock_requests internal_stock_requests_magasin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_internal_stock_requests internal_stock_requests_transfer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_internal_stock_requests internal_stock_requests_valide_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: magasins magasins_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: mouvements_caisse mouvements_caisse_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: mouvements_caisse mouvements_caisse_magasin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: mouvements_caisse mouvements_caisse_reversed_by_mouvement_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: mouvements_caisse mouvements_caisse_reverses_mouvement_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: mouvements_stock mouvements_stock_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: mouvements_stock mouvements_stock_transfer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: paiements paiements_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: paiements_fournisseur paiements_fournisseur_effectue_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: paiements_fournisseur paiements_fournisseur_magasin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: paiements_fournisseur paiements_fournisseur_mouvement_caisse_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: paiements_fournisseur paiements_fournisseur_session_caisse_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: paiements paiements_magasin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: paiements paiements_mouvement_caisse_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: paiements paiements_session_caisse_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payroll_runs payroll_runs_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payroll_runs
    ADD CONSTRAINT payroll_runs_cree_par_fkey FOREIGN KEY (cree_par) REFERENCES public.utilisateurs(id);


--
-- Name: payroll_runs payroll_runs_valide_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payroll_runs
    ADD CONSTRAINT payroll_runs_valide_par_fkey FOREIGN KEY (valide_par) REFERENCES public.utilisateurs(id);


--
-- Name: payslips payslips_employe_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payslips
    ADD CONSTRAINT payslips_employe_id_fkey FOREIGN KEY (employe_id) REFERENCES public.employes(id) ON DELETE RESTRICT;
...
--
-- Name: pos_cart_items pos_cart_items_produit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pos_cart_items pos_cart_items_session_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pos_sessions pos_sessions_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pos_sessions pos_sessions_utilisateur_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: produits produits_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: produits produits_modifie_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: produits produits_tiers_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: reception_lignes reception_lignes_produit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: reception_lignes reception_lignes_reception_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: receptions receptions_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: receptions receptions_receptionne_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: retour_lignes retour_lignes_facture_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: retour_lignes retour_lignes_produit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: retour_lignes retour_lignes_retour_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: retours retours_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: retours retours_tiers_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sessions_caisse sessions_caisse_caisse_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sessions_caisse sessions_caisse_cloturee_par_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sessions_caisse sessions_caisse_magasin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sessions_caisse sessions_caisse_ouverte_par_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sessions_caisse sessions_caisse_utilisateur_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: shifts_employes shifts_employes_employe_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: stock_locations stock_locations_responsable_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: stock_par_location stock_par_location_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: stock_par_location stock_par_location_produit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: stock_transfer_lignes stock_transfer_lignes_demande_ligne_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: stock_transfer_lignes stock_transfer_lignes_produit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: stock_transfer_lignes stock_transfer_lignes_transfer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: stock_transfers stock_transfers_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: stock_transfers stock_transfers_demande_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: stock_transfers stock_transfers_location_destination_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: stock_transfers stock_transfers_location_source_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_three_way_match_details_2026_05 three_way_match_details_match_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_three_way_match_details_2026_05 three_way_match_details_produit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_three_way_matches_2026_05 three_way_matches_reception_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: _deprecated_three_way_matches_2026_05 three_way_matches_valide_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: transferts_caisse transferts_caisse_caisse_dest_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: transferts_caisse transferts_caisse_caisse_source_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: transferts_caisse transferts_caisse_cree_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: transferts_caisse transferts_caisse_valide_par_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_location_roles user_location_roles_utilisateur_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_sessions user_sessions_utilisateur_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: utilisateur_locations utilisateur_locations_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: utilisateur_locations utilisateur_locations_utilisateur_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
